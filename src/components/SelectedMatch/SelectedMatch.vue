  ...
  <div class="selected-match">
    <div class="selected-match__content">
      ...
      <div class="selected-match__actions">
        <button
          class="selected-match__rate-button"
          :class="{
            'selected-match__rate-button--disabled': !matchIsFinished(match),
          }"
          :disabled="!matchIsFinished(match)"
          @click="showRateMatchInfo = !showRateMatchInfo"
        >
